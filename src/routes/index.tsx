...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Understand why your child behaves this way and learn simple ways to bring calm back to your home. Live on 27 July on Google Meet." },
        ...
        <div className="mt-6 md:mt-10 grid md:grid-cols-2 gap-6 md:gap-8 md:items-center">
          ...
          <div className="text-center md:text-left md:col-start-1 md:row-start-2">
            ...
            <div className="mt-7 space-y-3 max-w-md mx-auto md:mx-0">
              <CtaButton subtitle="Live on 27 July · Includes 3 free bonuses">Reserve My Seat</CtaButton>
              <a
                href="#curriculum"
                onClick={(e) => {
                  e.preventDefault();
      ...
      <div className="mx-auto max-w-2xl px-4">
        <div className="rounded-3xl bg-card border-2 border-accent/40 p-8 md:p-10 shadow-lg text-center">
          ...
          <div className="mt-7 max-w-sm mx-auto">
            <CtaButton subtitle="Live on 27 July · Includes 3 free bonuses">Reserve My Seat for 499 PKR</CtaButton>
          </div>
    ...
    <section className="hero-bg text-foreground py-16 md:py-24">
      <div className="mx-auto max-w-3xl px-4 text-center">
        ...
        <p className="mt-4 text-foreground/75 max-w-xl mx-auto">
          Join Miss Samra Riaz live on 27 July and learn simple ways to end the daily fights and
